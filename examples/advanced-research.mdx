...
# Advanced Research API Examples

This comprehensive guide shows you how to use the Advanced Research API across multiple programming languages. The Advanced Research system uses a director-worker agent pattern to conduct sophisticated research tasks with external search capabilities.
