...
| `max_loops` | `integer \| string` | No | `1` | Maximum number of times the agent can repeat its task, or `"auto"` |
...
| `reasoning_effort` | `string` | No | `"low"` | Reasoning effort level: `"low"`, `"medium"`, or `"high"` |
