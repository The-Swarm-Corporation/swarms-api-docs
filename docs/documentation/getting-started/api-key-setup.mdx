...
**Benefit**: New users automatically receive free API credits upon successful signup. Check `GET /v1/account/credits` (or the platform dashboard) for your current balance — billable endpoints require a total credit balance greater than \$1.00.
...
* Free credits are applied automatically to your account balance upon account creation
* No payment information required for initial usage
* Billable endpoints (`/v1/agent/completions`, `/v1/swarm/completions`, `/v1/chat/completions`, and the Premium endpoints) require a total credit balance greater than \$1.00
* Check your current balance anytime with `GET /v1/account/credits`
