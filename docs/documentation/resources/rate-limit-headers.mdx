...
description: 'Rate-limited API responses include X-RateLimit-* headers so you can track your usage and remaining quota in real time without making a separate API call.'
---
...
| `X-RateLimit-Limit-Hour` | integer | Maximum requests allowed per hour for your tier |
| `X-RateLimit-Remaining-Hour` | integer | Requests remaining in the current hour window |
...
X-RateLimit-Limit-Hour: 350
X-RateLimit-Remaining-Hour: 328
