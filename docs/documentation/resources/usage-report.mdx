...
| Lifetime/recent completion counts | `GET /v1/account/metrics/summary` | Unique agents used, lifetime and successful completion counts, completions in the last 24h/7d |
