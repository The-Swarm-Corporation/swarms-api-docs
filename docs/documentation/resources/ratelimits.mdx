...
| **Requests per Hour** | 350 | 10,000 | 1 hour | Maximum API calls per hour |
...
- **Premium Tiers**: 10 agents maximum per batch

- **Applies to**: `/v1/agent/batch/completions` and `/v1/swarm/batch/completions` endpoints
