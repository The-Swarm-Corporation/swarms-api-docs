...
- **`/v1/agent/batch/completions`**: 10 agent tasks maximum per batch. Returns a 400 error if exceeded, with message: "ERROR: BATCH SIZE EXCEEDED - You can only run up to 10 batch agents at a time."
