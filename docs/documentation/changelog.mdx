...
<Update label="September 14, 2026" description="Latest Updates" tags={["Documentation"]}>
# September 14, 2026 Updates

## Documentation
* **realign docs with the live OpenAPI spec** - Kye Gomez
* **add architecture pages for CouncilAsAJudge, LLMCouncil, and PlannerWorkerSwarm** - Kye Gomez
* **replace deprecated /v1/swarm/logs and /v1/metrics/summary references with /v1/account/logs and /v1/account/metrics/summary** - Kye Gomez
</Update>
