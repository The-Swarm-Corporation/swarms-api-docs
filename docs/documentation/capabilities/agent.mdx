...
Use pre-built prompts from the Swarms marketplace by specifying the `marketplace_prompt_id`. The system will automatically retrieve and use the prompt from the marketplace, allowing you to leverage community-created and tested prompts without writing your own system prompts.
