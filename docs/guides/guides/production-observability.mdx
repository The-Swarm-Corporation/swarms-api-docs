...
description: "Wire /v1/swarm/logs, /v1/usage/report, /v1/account/credits, and X-RateLimit-* headers into a single operator dashboard for cost, error, and quota visibility."
---
