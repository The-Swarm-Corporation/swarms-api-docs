---
title: "Hospital Team Example"
description: "Python code example for creating a hierarchical medical team swarm using the Swarms API."
---

## Overview

This example demonstrates how to create a hierarchical swarm simulating a hospital medical unit with a doctor (leader), nurses, and a medical assistant collaborating on patient care.
...
Run the script to simulate a medical team collaborating on patient care using a hierarchical swarm structure.
