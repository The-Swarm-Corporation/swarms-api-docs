...
EDGAR's Form 4 RSS feed publishes accession numbers in close to real time. Pull the day's list at 5:30pm ET and submit it in chunks — `/v1/swarm/batch/completions` accepts at most 50 swarms per request.
