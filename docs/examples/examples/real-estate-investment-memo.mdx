...
<Info>
This tutorial uses `HierarchicalSwarm` — the same primitive used by institutional research desks. To run memos on dozens of properties per day or wire this into a Slack bot for your acquisitions team, upgrade at [https://cloud.swarms.world/settings](https://cloud.swarms.world/settings).
</Info>
