...
<Warning>
Premium: Graph Workflow is available only on Pro, Ultra, and Premium plans. See [Pricing](/docs/documentation/resources/pricing).
</Warning>
...
# Display cost info. GraphWorkflowOutput.usage is a flat object -
# {input_tokens, output_tokens, total_tokens, total_cost, cost_per_agent} -
# not the nested `billing_info` shape /v1/swarm/completions returns.
