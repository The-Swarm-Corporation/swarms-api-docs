...
| Swarms turns × 5 (router + specialist, `gpt-4.1-mini`) | ~\$0.22 |
...
| Voice agent stack at \$0.33/call | ~\$2,650 | 24/7 | ~8,000 |
| Same stack at high volume (50k calls) | ~\$16,500 | 24/7 | ~50,000 |
