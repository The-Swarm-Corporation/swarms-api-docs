...
Each entry has `id` (the model identifier you pass as `model_name` or `model`), `object` (always `"model"`), `created`, and `owned_by` (the resolved provider, e.g. `openai`, `anthropic`). See the [OpenAI-Compatible Endpoint](/docs/documentation/capabilities/openai-compatible) reference for using these models with the OpenAI SDK.
...
<Tabs>
  ...
  <Tab title="Fast Responses">
    ...
    recommended_models = [
        ...
        "claude-haiku-4-5"         # Fast with good quality
    ]
    ```
  </Tab>
</Tabs>
    ...
    def select_best_model(task_type, priority="balanced"):
        ...
        if task_type == "creative":
            if priority == "quality":
                ...
                return "gpt-4.1-mini" if "gpt-4.1-mini" in available_models else "claude-haiku-4-5"
            else:  # balanced
                return "gpt-4.1-mini"
            ...
            return "gpt-4.1-mini" if "gpt-4.1-mini" in available_models else "groq/llama-3.1-8b-instant"
    ...
    function selectBestModel(taskType, priority = "balanced") {
        ...
        const modelPreferences = {
            creative: {
                ...
                speed: ["gpt-4.1-mini", "claude-haiku-4-5"],
                balanced: ["gpt-4.1-mini"],
                cost: ["gpt-4.1-mini", "groq/llama-3.1-8b-instant"]
            },
            analytical: {
                quality: ["gpt-4.1", "claude-sonnet-4-20250514"],
                speed: ["gpt-4-turbo"],
            ...
            fast: {
                ...
                speed: ["gpt-4.1-mini", "groq/llama-3.1-8b-instant"],
                balanced: ["gpt-4.1-mini"],
                cost: ["gpt-4.1-mini", "groq/llama-3.1-8b-instant"]
            },
            vision: {
...
| `claude-haiku-4-5` | 200k+ | Fast responses | Fast | Low |
| `groq/llama-3.3-70b-versatile` | 128k | Complex tasks | Medium | Medium |
| `groq/llama-3.1-8b-instant` | 128k | Simple tasks | Fast | Low |
  ...
  <Tab title="Python">
    ...
    def optimize_model_selection(task_complexity, budget_constraint):
        ...
        if task_complexity == "low":
            return "gpt-4.1-mini" if budget_constraint == "strict" else "groq/llama-3.1-8b-instant"
  ...
  <Tab title="JavaScript">
    ...
    function optimizeModelSelection(taskComplexity, budgetConstraint) {
        const optimizationMatrix = {
            low: {
                strict: "gpt-4.1-mini",
                flexible: "groq/llama-3.1-8b-instant"
            },
            medium: {
                strict: "gpt-4.1-mini",
                flexible: "gpt-4.1"
