  ...
  <Tab title="Python">
    ...
    def select_best_model(task_type, priority="balanced"):
        ...
        if task_type == "creative":
            if priority == "quality":
                return "gpt-4.1" if "gpt-4.1" in available_models.get("openai", []) else "claude-sonnet-4-20250514"
            elif priority == "speed":
                return "gpt-4.1-mini" if "gpt-4.1-mini" in available_models.get("openai", []) else "claude-haiku-3.5"
            else:  # balanced
                return "gpt-4.1-mini"
            ...
            return "gpt-4.1-mini" if "gpt-4.1-mini" in available_models.get("openai", []) else "llama-3.1-8b-instant"

        elif task_type == "vision":
            return "gpt-4.1" if "gpt-4.1" in available_models.get("openai", []) else "gpt-4-turbo"
