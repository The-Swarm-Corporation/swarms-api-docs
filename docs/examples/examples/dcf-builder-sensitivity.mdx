...
- [Build a 24/7 Autonomous Equity Research Analyst](/docs/examples/examples/247-autonomous-equity-research-analyst) — the production pattern for shipping the memo to Slack on a cron
