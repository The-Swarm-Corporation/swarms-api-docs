...
- **Add a Weather Briefer** — fourth concurrent agent, `search_enabled: True`, prompt: "One-line forecast and high/low for {city}".
...
- [Search-Enabled Agents](/docs/examples/examples/search-enabled) — every option on the `search_enabled` flag, including how to inspect the citations
