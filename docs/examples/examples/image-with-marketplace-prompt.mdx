...
<Info>
You need an API key and the Python client. Get your key at [swarms.world/platform/api-keys](https://swarms.world/platform/api-keys). Find marketplace prompts on [swarms.world](https://swarms.world/marketplace).
</Info>
...
Choose a **marketplace prompt ID** for your agent. The prompt defines the agent's system prompt, name, and description. Browse prompts on [swarms.world](https://swarms.world/marketplace) to find one that fits vision or general analysis. Example ID used below: `72021048-6f31-48b6-b624-7732e6f93437`.
...
For more details, see [Vision Capabilities](/docs/examples/examples/vision-capabilities).
