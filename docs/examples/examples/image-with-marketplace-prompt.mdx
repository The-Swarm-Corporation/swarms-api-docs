...
For more details, see [Vision Capabilities](/docs/examples/examples/vision-capabilities) and [Using marketplace prompts with agents](/docs/marketplace/prompts-api#using-marketplace-prompts-with-agents).
