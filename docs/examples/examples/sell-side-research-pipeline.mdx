...
<Info>
This pipeline processes a high volume of PDF documents per day. `/v1/swarm/batch/completions` (Step 5) is a **premium-only** endpoint (Pro, Ultra, Premium) — the Free tier caps you at 1,200 requests per day, which this end-of-day sweep across 150+ notes will exceed. Read the [Cost Optimization Playbook](/docs/guides/guides/cost-optimization-playbook) before turning the cron on, and upgrade at [https://cloud.swarms.world/settings](https://cloud.swarms.world/settings).
</Info>
    ...
    return {
        ...
        "agents": [
            ...
            },
            {
                ...
                "max_tokens": 1024,
                "temperature": 0.0,
                "tools_list_dictionary": [EXTRACT_RATING_TOOL],
            },
            {
                ...
                "max_tokens": 1024,
                "temperature": 0.0,
                "tools_list_dictionary": [EXTRACT_TARGET_TOOL],
            },
            {
                ...
                "max_tokens": 2048,
                "temperature": 0.2,
                "tools_list_dictionary": [EXTRACT_DRIVERS_TOOL],
            },
        ],
    }
```
...
for r in results:
    director_msg = next(
        (o for o in r.get("result", []) if "Research Director" in o.get("role", "")),
        None,
    )
    if not director_msg:
        continue
