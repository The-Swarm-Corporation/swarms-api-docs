...
description: "Manage account settings, profile data, billing, subscriptions, and wallet details on Swarms."
---
...
- **Current Plan:**  
  Options include **Free**, **Pro**, or **Premium**.
...
- [Support](https://swarms.world/support)
