---
title: "Marketplace Publishing Quickstart"
description: "Publish agents to the Swarms Marketplace quickly with required metadata and API key setup."
---
...
## Step 3: Publishing Happens on Creation

Constructing the agent above already published it. Run it as usual:

```python
# The agent was published when it was constructed above
...
# Step 3: Run the agent (it was published when it was created above)
...
```python
from swarms.agents import AgentMarketplaceHandler

response = AgentMarketplaceHandler.add_prompt(
...
| [Marketplace Documentation](/docs/marketplace/share_and_discover) | Learn how to publish and discover agents |
| [Monetization Options](/docs/marketplace/monetize) | Explore ways to monetize your agent |
| [API Key Management](/docs/marketplace/apikeys) | Manage your API keys for publishing and access |
