---
title: "Introduction"
description: "Welcome to the Swarms Platform for sharing, discovering, and hosting agents and agent swarms."
---
...
- **URL**: [Usage Monitoring](https://swarms.world/platform/account/transactions)
...
- [API Documentation](https://docs.swarms.ai)
- [Community Forums](https://discord.gg/EamjgSaEQf)
- [Tutorials and Guides](https://docs.swarms.ai)
