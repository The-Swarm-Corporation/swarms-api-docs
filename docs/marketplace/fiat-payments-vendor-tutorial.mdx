...
Your Stripe onboarding isn't complete. Open the Seller tab, click **Continue onboarding**, and finish the remaining steps, then click the re-check link on the launch page.
