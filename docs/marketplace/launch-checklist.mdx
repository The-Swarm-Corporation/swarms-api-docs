...
<Steps>
  ...
  <Step title="Visual Assets">
    Create a professional logo/image (max 60MB) that clearly represents your agent's purpose and brand. For marketplace banner/hero images, use **16:9** and the **best resolution** of **1920×1080** to avoid cropping and blurriness.
  </Step>
...
<Check>High-quality image/logo (best: 16:9 at 1920×1080)</Check>
...
<Steps>
  ...
  <Step title="Select Product Type">
    Choose **Agent**, **Prompt**, **Tool**, or **Bundle** based on your product.
  </Step>
