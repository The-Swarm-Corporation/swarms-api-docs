---
title: "API Keys"
description: "Create, manage, and secure API keys for programmatic access to your Swarms account."
---
...
1. **Attach a Credit Card (only if you have no credits):**  
   A card is required only when your account has no remaining credit balance. Accounts that still hold free, purchased, or referral credits can create a key without one.
...
**A:** A card is only requested once your credit balance reaches zero. It helps verify your identity and manage billing, ensuring responsible usage of the API services provided by the Swarms Platform.
...
For any further questions or issues regarding API key management, please refer to our [Support page](https://swarms.world/support) or contact our support team.
