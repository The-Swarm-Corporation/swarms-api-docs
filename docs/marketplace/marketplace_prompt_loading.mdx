---
title: "Marketplace Prompt Loading"
description: "Load production-ready prompts from the Swarms Marketplace directly into your agents."
---
...
2. **Appends the prompt** to the agent's system prompt
...
| Agent not using expected prompt | The marketplace prompt is appended to any `system_prompt` you set |

## Related Resources

- [Swarms Marketplace](https://swarms.world/marketplace) - Browse available prompts
- [Publishing Prompts](/docs/marketplace/monetize) - Share your own prompts
- [Agent Reference](/docs/documentation/capabilities/agent) - Full agent documentation
- [API Key Management](/docs/marketplace/apikeys) - Manage your API keys
